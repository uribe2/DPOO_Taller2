...
public class SandboxMapas
{
    ...
    {
    	String llaveInv = new StringBuilder(cadena).reverse().toString();
    	mapaCadenas.put(llaveInv, cadena);
    }
    ...
    {
    	Map<String, String> mapYuscula = new HashMap<>();
        for (Map.Entry<String, String> entry : mapaCadenas.entrySet()) {
            mapYuscula.put(entry.getKey().toUpperCase(), entry.getValue());
        }
        mapaCadenas = mapYuscula;
    }
